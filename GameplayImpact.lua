...
local function runMainScript()
    ...
    local Games = loadstring(game:HttpGet("https://raw.githubusercontent.com/Scripybara/Swiftbara-Hub-Midnight-Chasers-Premium-Version/refs/heads/main/main.lua"))()
